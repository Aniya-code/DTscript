...
#     video_seg_end_time = video_timeline[video_seg_end_idx]-1
#     audio_seg_start_time = audio_timeline[audio_seg_start_idx]
#     audio_seg_end_time = audio_timeline[audio_seg_end_idx]-1
#     if audio_seg_start_time - video_seg_start_time > -5000 and audio_seg_end_time - video_seg_end_time > -5000:
#         return True
#     return False
...
if __name__ == '__main__':
    ...
    # test_case = "1098108, 3225775, 2502229, 1498159, 1611226, 1610470, 1672560, 1644680, 1650487, 1677452, 1677057"
    # test_case = list(map(int, test_case.split(', ')[2:]))
    # main(test_case)